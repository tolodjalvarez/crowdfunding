...
$myusuario = mysql_query("select usuarioid from tblusuario where usuarioid = '".htmlentities($_POST["usuario"])."'",$link); 
$nmyusuario = mysql_num_rows($myusuario); 

//Si existe el usuario, validamos también la contraseña ingresada y el estado del usuario... 
if($nmyusuario != 0)
{ 
  $sql = "select usuarioid from tblusuario where activo = 1 and usuarioid = '".htmlentities($_POST["usuario"])."' and clave = '".md5(htmlentities($_POST["clave"]))."'"; 
  ...
  { 
      ...
      header ("Location: ./procesos/Menu1.php"); 
   }
   else{ 
